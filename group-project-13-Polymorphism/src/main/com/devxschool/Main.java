...
public class Main {
    ...
    public static void main(String[] args) {
         ...
         *  - 'printSpeedAndGroup': print SUPER FAST if more than 60, FAST if more than 40,
         *     MEDIUM if more than 20, and SLOW if less or equal to 20.
         *     After, assign moveType to run
         *
         * And there is a Tortoise class:
         *  - 'printSpeedAndGroup': print SUPER FAST if more than 1, FAST if more than 0.6,
         *     MEDIUM if more than 0.3, and SLOW if less or equal to 0.3.
        ...
        a1.setName("Animal Test");
        a1.setMoveTape("swim");
        a1.setSound("boom");
        a1.printSpeedAndGroup(50);
        ...
        h.setName("sprint");
        h.setSound("neigh");
        h.printSpeedAndGroup(60);
        System.out.println(h.toString + "\n");

        Tortoise t = new Tartoise();
        t.setName("Verne");
        t.printSpeed
