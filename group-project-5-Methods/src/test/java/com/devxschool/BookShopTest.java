...
public class BookShopTest {
    ...
    public void countFreeBooksTest() {
        ...
        assertEquals("premium account with 5 books should get 1 free book", 1, result);
    ...
    public void countFreeBooksTest5() {
        ...
        assertEquals("not premium account with 7 books should get 1 free books", 1, result);
