...
//    public void user_enters_the_valid_information_for_creating_the_savings_account(????????) {
//        NewSavingsPage newSavingsPage = new NewSavingsPage();
...
//    }
    ...
    @When("user enters the account name {string} and the initial deposit {int}")
    public void user_enters_the_account_name_test_account_and_the_initial_deposit(Integer int1) {
